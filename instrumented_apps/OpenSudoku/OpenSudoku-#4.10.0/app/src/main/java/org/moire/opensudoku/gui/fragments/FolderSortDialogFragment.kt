...
import org.moire.opensudoku.gui.screen.folder_list.FolderListSorter

class FolderSortDialogFragment : DialogFragment() {
	override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
		val builder = AlertDialog.Builder(requireActivity())
			.setIcon(R.drawable.ic_sort)
			.setTitle(R.string.sort_folders_by)
			.setSingleChoiceItems(R.array.folder_sort, listSorter.sortType) { _: DialogInterface?, whichButton: Int ->
	...
	companion object {
		var listSorter = FolderListSorter()
		private val requestKey: String = FolderSortDialogFragment::class.java.simpleName
